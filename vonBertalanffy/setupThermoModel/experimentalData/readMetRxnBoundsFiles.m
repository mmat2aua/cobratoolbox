function model=readMetRxnBoundsFiles(model,setDefaultConc,setDefaultFlux,metBoundsFile,rxnBoundsFile)
...
% model.mets
% model.rxns
% setDefaultConc            1 = sets default bounds on conc   [1e-5,0.02]     
